...
<head>
    ...
    <title>การจัดการประเภทผ้าทอ</title>
...
<body>
    ...
    <main class="page-content">
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h2>ตารางข้อมูลประเภทผ้าทอ</h2>
                                </div>
                                <div class="col-sm-6">
                                    <a href="#insertSilkType" role="button" data-bs-toggle="modal" class="btn btn-success p-2 ps-3 pe-3 rounded"><i class="fas fa-plus-square"></i><span><b>เพิ่มประเภทผ้าทอ</b></span></a>						
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>ลำดับ</th>
                                    <th class="text-center">ประเภทผ้าทอ</th>
                                    <th>แก้ไข/ลบ</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $objSilkType->FetchAllSilkType(); ?>
                            </tbody>
                        </table>
                    </div>
                </div>        
        ...
        <!-- Insert Admin Modal -->
        <?php include 'Layout/insertSilkTypeModal.php'; ?>
    </main>
    <!-- page-content" -->
    </div>
    <!-- page-wrapper -->
