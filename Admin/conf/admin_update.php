<?php
    ...
    if(isset($_POST['btn_update'])) {
        ...
        try {
            ...
            $sql = "UPDATE admin_user SET user_id = :uID ,username = :uname ,password = :upasswd ,fullname = :ufname ,email = :uemail ,phone_num = :utel WHERE user_id = '$id'";

            $update_stmt = $objServer->connected()->prepare($sql);
            $update_stmt->bindParam(":uID" ,$up_IDdb);
