...
<body>
    ...
    <?php
        ...
        if(!empty($_REQUEST['admin_id'])){
            ...
            $edit_stmt = $db->prepare("SELECT * FROM admin_user WHERE user_id = '$id'");
            $edit_stmt->execute();
        ...
        <div class="row">   
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Insert Admin</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Overview</li>
                    </ol>
                </nav>
                <h2 class="fs-3">แก้ไขมูลแอดมิน</h2>

                <form action="admin_update.php" method="post" class="border border-2 p-3 rounded-2">
                    <div class="row mt-3">
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                        <div class="col">
                            <label class="form-label">Username</label>
                            <input class="form-control" name="username" type="text" value="<?php echo $username; ?>" aria-label="default input example">
                        </div>
                        <div class="col">
                            <label class="form-label">Password</label>
                            <input class="form-control" name="password" id="exampleInputPassword1" type="password" value="<?php echo $password; ?>" maxlength="6">
                            <div id="emailHelp" class="form-text text-danger">* รหัสทั้งหมด 6 ตัว</div>
                        </div>
                        <div class="w-100"></div>
                        <div class="col">
                            <label class="form-label">ชื่อ - นามสกุล</label>
                            <input class="form-control" name="fname" type="text" value="<?php echo $fullname; ?>" aria-label="default input example">
                        </div>
                        <div class="col">
                        ...
                        <div class="w-100"></div>
                        <div class="col mt-4">
                            <label for="" class="form-label">เบอร์โทรศัพย์</label>
                            <input type="tel" name="phone_num" class="form-control fs-5" maxlength="11" value="<?php echo $phone_num; ?>" placeholder="000-0000000" pattern="[0-9]{3}-[0-9]{7}" required>
                        </div>
                        <div class="w-100"></div>
                        <div class="col mt-3">
