    ...
    <?php  
        ...
        if(isset($_POST['btn_insert'])) {
            ...
            try {
                ...
                $insert_stmt->bindParam(3 ,$fullname);
                $insert_stmt->bindParam(4 ,$email);
                $insert_stmt->bindParam(5 ,$p_num);
    ...
    <div class="container-fluid">
        <div class="row">   
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                ...
                <form method="post" class="border border-2 p-3 rounded-2">
                    <div class="row mt-3">
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <input class="form-control" name="password" type="password" placeholder="Password" maxlength="6" aria-label="default input example">
                            <div id="emailHelp" class="form-text text-danger">* รหัสทั้งหมด 6 ตัว</div>
                        </div>
                        <div class="w-100"></div>
                        <div class="col">
                            <label class="form-label">ชื่อ - นามสกุล</label>
                            <input class="form-control" name="fname" type="text" placeholder="ชื่อ - นามสกุล" aria-label="default input example">
                        </div>
                        <div class="col">
                        ...
                        <div class="col mt-4">
                            ...
                            <input type="tel" name="phone_num" class="form-control fs-5" maxlength="11" placeholder="000-0000000" pattern="[0-9]{3}-[0-9]{7}" required>
                        </div>
                        <div class="w-100"></div>
                        <div class="col mt-3">
